...
Read the code and identify all bugs
Fix every bug automatically
Run the fixed code and validate it works
If validation fails → loop retries automatically up to 3 times
...
LayerTechnologyFrontendReact.jsBackendPython + FlaskAI AgentsGroq API (Llama 3.3 70B)Code RunnerPython subprocess + tempfileAgent FrameworkCustom multi-agent pipelineStylingDark GitHub-inspired design
